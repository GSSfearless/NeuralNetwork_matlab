function [error_train, error_test, out_1, out_2, predict] = batch_trainbr(n, epoch,lr) 
b = 1.6;
x = -b:0.05:b;              % training dataset
y = 1.2*sin(pi*x) - cos(2.4*pi*x);
net = newff(minmax(x),[1,n,1],{'logsig','logsig','purelin'},'trainbr');
